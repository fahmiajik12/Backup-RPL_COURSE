...
<head>
	...
	<title>Tentang Developer - Socamp</title>
	<!-- General CSS Files -->
				...
				<section class="section">
					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Tentang Socamp</h2>
								<hr>
								<p class="card-text">Web Edukasi Open Source yang dibuat oleh Kelompok1. <br> Socamp adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. <br> Socamp dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja. </p>
							</div>
						</div>
					</div>
				</section>
