...
<head>
    ...
    <meta content="Socamp dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja." name="Description" />
    <meta content="Socamp, E-learning, Open Source, Kelompok1, github, programmer indonesia" name="keywords" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/favicon.png" type="image/png">
    <title>Socamp - Belajar Dimana Saja & Kapan Saja !</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="mailto:apps.Socamp@gmail.com">apps.Socamp@gmail.com</a>
                </div>
            </div>
        </div>
